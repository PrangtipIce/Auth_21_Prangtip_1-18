                    ...
                    <div class="tab-pane fade active show" id="menu-starters">
                        ...
                        <div class="row gy-5">
                            ...
                            <div class="col-lg-4 menu-item">
                                <a href="{{ asset('frontend/assets/img/menu/menu-item-1.jpg') }}"
                                    class="glightbox"><img
                                        src="{{ asset('frontend/assets/img/menu/menu-item-1.jpg') }}"
                            ...
                            <div class="col-lg-4 menu-item">
                                <a href="{{ asset('frontend/assets/img/menu/menu-item-2.jpg') }}"
                                    class="glightbox"><img
                                        src="{{ asset('frontend/assets/img/menu/menu-item-2.jpg') }}"
                                        class="menu-img img-fluid" alt=""></a>
                            ...
                            <div class="col-lg-4 menu-item">
                                <a href="{{ asset('frontend/assets/img/menu/menu-item-3.jpg') }}"
                                    class="glightbox"><img
                                        src="{{ asset('frontend/assets/img/menu/menu-item-3.jpg') }}"
                                        class="menu-img img-fluid" alt=""></a>
                            ...
                            <div class="col-lg-4 menu-item">
                                <a href="{{ asset('frontend/assets/img/menu/menu-item-4.jpg') }}"
                                    class="glightbox"><img
                                        src="{{ asset('frontend/assets/img/menu/menu-item-4.jpg') }}"
                                        class="menu-img img-fluid" alt=""></a>
                            ...
                            <div class="col-lg-4 menu-item">
                                <a href="{{ asset('frontend/assets/img/menu/menu-item-6.jpg') }}"
                                    class="glightbox"><img
                                        src="{{ asset('frontend/assets/img/menu/menu-item-6.jpg') }}"
                                        class="menu-img img-fluid" alt=""></a>
                            ...
                            <div class="col-lg-4 menu-item">
                                <a href="{{ asset('frontend/assets/img/menu/menu-item-5.jpg') }}"
                                    class="glightbox"><img
                                        src="{{ asset('frontend/assets/img/menu/menu-item-5.jpg') }}"
                                        class="menu-img img-fluid" alt=""></a>
                                                ...
                                                <div class="col-lg-6">
                                                    <div class="testimonial-content">
                                                        <p>
                                                            ...
                                                            เลือกเลยครับไม่ต้องกลัวไม่อร่อย อร่อยหมดเลยครับ
                                                            แนะนำไข่เจียวห่อหมก กับ ข้าวผัดมันกุ้งครับ อยากให้ลอง
                                                            อาหารอร่อย
                                            ...
                                            <div class="row gy-4 justify-content-center">
                                                <div class="col-lg-6">
                                                    <div class="testimonial-content">
                                                        <p>
                                                            <i class="bi bi-quote quote-icon-left"></i>
                                                            อร่อยมาก บริการดี อาหารราคาถูกไม่แพง​ บรรยาการดี
                                                            ร้านสะอาด​น่านั่ง
                                                            <i class="bi bi-quote quote-icon-right"></i>
                                                        </p>
                        ...
                        <div class="container" data-aos="fade-up">
                            ...
                            <div class="row gy-4">
                                ...
                                <div class="col-lg-4 col-md-6 d-flex align-items-stretch" data-aos="fade-up"
                                    ...
                                    <div class="chef-member">
                                        <div class="member-img">
                                            <img src="{{ asset('frontend/assets/img/chefs/chefs-1.jpg') }}"
                                                class="img-fluid" alt="">
                                            <div class="social">
                                ...
                                <div class="col-lg-4 col-md-6 d-flex align-items-stretch" data-aos="fade-up"
                                    ...
                                    <div class="chef-member">
                                        <div class="member-img">
                                            <img src="{{ asset('frontend/assets/img/chefs/chefs-2.jpg') }}"
                                                class="img-fluid" alt="">
                                            <div class="social">
                                                <a href=""><i class="bi bi-facebook"></i></a>
                                                <a href=""><i class="bi bi-twitter"></i></a>
                                ...
                                <div class="col-lg-4 col-md-6 d-flex align-items-stretch" data-aos="fade-up"
                                    ...
                                    <div class="chef-member">
                                        <div class="member-img">
                                            <img src="{{ asset('frontend/assets/img/chefs/chefs-3.jpg') }}"
                                                class="img-fluid" alt="">
                                            <div class="social">
                                                <a href=""><i class="bi bi-facebook"></i></a>
                                                <a href=""><i class="bi bi-twitter"></i></a>
                        ...
                        <div class="container" data-aos="fade-up">
                            ...
                            <div class="row g-0">
                                ...
                                <div class="col-lg-4 reservation-img"
                                    style="background-image: url(frontend/assets/img/reservation.jpg);"
                                ...
                                <div class="swiper-wrapper align-items-center">
                                    <div class="swiper-slide"><a class="glightbox" data-gallery="images-gallery"
                                            href="{{ asset('frontend/assets/img/gallery/gallery-1.jpg') }}"><img
                                                src="{{ asset('frontend/assets/img/gallery/gallery-1.jpg') }}"
                                                class="img-fluid" alt=""></a></div>
                                    <div class="swiper-slide"><a class="glightbox" data-gallery="images-gallery"
                                            href="{{ asset('frontend/assets/img/gallery/gallery-2.jpg') }}"><img
                                                src="{{ asset('frontend/assets/img/gallery/gallery-2.jpg') }}"
                                                class="img-fluid" alt=""></a></div>
                                    <div class="swiper-slide"><a class="glightbox" data-gallery="images-gallery"
                                            href="{{ asset('frontend/assets/img/gallery/gallery-3.jpg') }}"><img
                                                src="{{ asset('frontend/assets/img/gallery/gallery-3.jpg') }}"
                                                class="img-fluid" alt=""></a></div>
                                    <div class="swiper-slide"><a class="glightbox" data-gallery="images-gallery"
                                            href="{{ asset('frontend/assets/img/gallery/gallery-4.jpg') }}"><img
                                                src="{{ asset('frontend/assets/img/gallery/gallery-4.jpg') }}"
                                                class="img-fluid" alt=""></a></div>
                                    <div class="swiper-slide"><a class="glightbox" data-gallery="images-gallery"
                                            href="{{ asset('frontend/assets/img/gallery/gallery-5.jpg') }}"><img
                                                src="{{ asset('frontend/assets/img/gallery/gallery-5.jpg') }}"
                                                class="img-fluid" alt=""></a></div>
                                    <div class="swiper-slide"><a class="glightbox" data-gallery="images-gallery"
                                            href="{{ asset('frontend/assets/img/gallery/gallery-6.jpg') }}"><img
                                                src="{{ asset('frontend/assets/img/gallery/gallery-6.jpg') }}"
                                                class="img-fluid" alt=""></a></div>
                                    <div class="swiper-slide"><a class="glightbox" data-gallery="images-gallery"
                                            href="{{ asset('frontend/assets/img/gallery/gallery-7.jpg') }}"><img
                                                src="{{ asset('frontend/assets/img/gallery/gallery-7.jpg') }}"
                                                class="img-fluid" alt=""></a></div>
                                    <div class="swiper-slide"><a class="glightbox" data-gallery="images-gallery"
                                            href="{{ asset('frontend/assets/img/gallery/gallery-8.jpg') }}"><img
                                                src="{{ asset('frontend/assets/img/gallery/gallery-8.jpg') }}"
                                                class="img-fluid" alt=""></a></div>
                                </div>
                                <div class="swiper-pagination"></div>
                            </div>
